...
\begin{frame}{Equal diffusion shifts every spatial mode toward stability}
  ...
  \begin{center}
    \includegraphics[
      ...
      height=6.75cm,
      keepaspectratio
    ]{figures/C_turing_instability/lax_14022_elife-14022-app3-fig1-v4.jpg}
  \end{center}
...
\begin{frame}{Unequal diffusion can amplify a spatial mode}
  ...
  \begin{center}
    \includegraphics[
      ...
      height=6.75cm,
      keepaspectratio
    ]{figures/C_turing_instability/lax_14022_elife-14022-app3-fig1-v3.tif.jpg}
  \end{center}
...
\begin{frame}{Homogeneous steady state}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.90cm,keepaspectratio]{figures/C_turing_instability/...}
...
\begin{frame}{Perturb both concentrations around the steady state}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=2.20cm,keepaspectratio]{figures/C_turing_instability/...}
...
\begin{frame}{Spatial eigenfunctions separate the perturbation}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.95cm,keepaspectratio]{figures/C_turing_instability/...}
...
\begin{frame}{Diffusion makes the trace more negative}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.80cm,keepaspectratio]{figures/C_turing_instability/...}
      \begin{tikzpicture}[x=0.88cm,y=0.88cm]
        \draw[-{Latex[length=2.2mm]},HydraMuted,line width=0.75pt]
          (0.45,3.60) -- (5.70,3.60)
...
\begin{frame}{Only eigenvalues inside the unstable band can grow}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.72\textwidth}
      ...
      % \includegraphics[width=\linewidth,height=5.20cm,keepaspectratio]{figures/C_turing_instability/...}
...
\begin{frame}{Diffusion changes which modes are unstable}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.67\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=5.25cm,keepaspectratio]{figures/C_turing_instability/...}
...
\begin{frame}{A larger domain can support more peaks}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.47\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=3.45cm,keepaspectratio]{figures/C_turing_instability/...}

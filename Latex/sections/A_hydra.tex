...
\begin{frame}{Hydra: simple body, continuous renewal}
  ...
  }{figures/A_hydra/hydra_staining.jpg}
...
\begin{frame}{Hydra can rebuild a whole animal from very little}
  ...
  }{figures/A_hydra/Hydra2.jpg}{Wittlieb J et al., Dev Biol. 2006; 296(1):62-70.}
\end{frame}
    ...
    \begin{tikzpicture}
      \node[
        ...
        \includegraphics[
          ...
          height=4.85cm,
          keepaspectratio
        ]{figures/A_hydra/hydra_regeneration_routes.png}
      };
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
      \node[
        ...
        \includegraphics[
          ...
          height=4.95cm,
          keepaspectratio
        ]{figures/A_hydra/hydra_symmetry_breaking_zoom.png}
      };
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
      \node[
        ...
        \includegraphics[
          ...
          height=5.05cm,
          keepaspectratio
        ]{figures/A_hydra/a_clean_scientific_diagram_infographic_figure_wi_1.png}
      };
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
      \node[
        ...
        \includegraphics[
          ...
          height=4.70cm,
          keepaspectratio
        ]{figures/A_hydra/grafting_timecourse.jpg}
      };
    \end{tikzpicture}

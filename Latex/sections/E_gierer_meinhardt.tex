...
\begin{frame}{The nullclines}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.52\textwidth}
      ...
      % \includegraphics[width=\linewidth,height=5.25cm,keepaspectratio]{figures/E_gierer_meinhardt/nullclines.png}
...
\begin{frame}{Possible steady states}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.62\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.95cm,keepaspectratio]{figures/E_gierer_meinhardt/saddle_node.png}
...
\begin{frame}{The zero steady state is always stable}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.36\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.85cm,keepaspectratio]{figures/E_gierer_meinhardt/origin_stability.png}
...
\begin{frame}{The lower positive steady state is a saddle}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.85cm,keepaspectratio]{figures/E_gierer_meinhardt/saddle_portrait.png}
...
\begin{frame}{The upper positive steady state can be stable}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.51\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.85cm,keepaspectratio]{figures/E_gierer_meinhardt/node_spiral.png}
...
\begin{frame}{The saddle separates the two stable outcomes}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.65\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=5.35cm,keepaspectratio]{figures/E_gierer_meinhardt/full_phase_portrait.png}
...
\begin{frame}{Only GM eigenmodes inside the unstable band can grow}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.70\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=5.05cm,keepaspectratio]{figures/E_gierer_meinhardt/unstable_modes.png}
      \begin{tikzpicture}[x=0.88cm,y=0.88cm]
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.68\textwidth}
      ...
      \includegraphics[
        ...
        height=5.20cm,
        keepaspectratio
      ]{figures/E_gierer_meinhardt/gm_example_nullclines.png}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.70\textwidth}
      ...
      \includegraphics[
        ...
        height=5.10cm,
        keepaspectratio
      ]{figures/E_gierer_meinhardt/gm_example_mode_growth_rates.png}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.70\textwidth}
      ...
      \includegraphics[
        ...
        height=5.10cm,
        keepaspectratio
      ]{figures/E_gierer_meinhardt/gm_example_mode_growth_rates_L10.png}
...
%       % REPLACEABLE VISUAL
%       % Replace the tikzpicture with:
%       % \includegraphics[width=\linewidth,height=5.10cm,keepaspectratio]{figures/E_gierer_meinhardt/linear_to_nonlinear.png}
%       \begin{tikzpicture}[x=0.90cm,y=0.90cm]

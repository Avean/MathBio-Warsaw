  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.67\textwidth}
      ...
      \includegraphics[
        ...
        height=5.20cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/hydra_biology.png}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.72\textwidth}
      ...
      \includegraphics[
        ...
        height=5.25cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/oscillation_radius.png}
    \end{column}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.72\textwidth}
      ...
      \includegraphics[
        ...
        height=5.15cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/oscillation_wnt3_oe.jpg}
    \end{column}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.62\textwidth}
      ...
      \includegraphics[
        ...
        height=5.35cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/3d_intersection.jpg}
    \end{column}
...
%         height=4.95cm,
%         keepaspectratio
%       ]{figures/G_mechanochemistry/sphere_springs.png}
%     \end{column}
...
\begin{frame}{The parameter space}
  ...
  \vspace{-0.16cm}
      ...
      \includegraphics[
        ...
        height=7.05cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/parameter_space.png}
...
\begin{frame}{Diffusion changes the width but not the number of peaks}
  ...
  \begin{center}
    \includegraphics[
      ...
      height=4.55cm,
      keepaspectratio
    ]{figures/G_mechanochemistry/stationary_profiles.png}
  \end{center}
...
\begin{frame}{Bifurcation diagram}
  ...
  \begin{center}
    \includegraphics[
      ...
      % height=4.35cm,
      keepaspectratio
    ]{figures/G_mechanochemistry/Comparison2.png}
  \end{center}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.73\textwidth}
      ...
      \includegraphics[
        ...
        height=7.25cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/bifurcation_parameter_map.png}
    \end{column}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.62\textwidth}
      ...
      \includegraphics[
        ...
        height=5.05cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/subcritical_bifurcation.png}
    \end{column}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.62\textwidth}
      ...
      \includegraphics[
        ...
        height=5.05cm,
        keepaspectratio
      ]{figures/G_mechanochemistry/supercritical_bifurcation.png}
    \end{column}

...
\begin{frame}{Reaction system}
  ...
  {\color{HydraMuted}\fontsize{8.2}{10.1}\selectfont
    Looking for steady states and analysing stability
  \par}
...
\begin{frame}{The nullclines}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.52\textwidth}
      ...
      % \includegraphics[width=\linewidth,height=5.25cm,keepaspectratio]{figures/gierer_meinhardt/nullclines.png}
...
\begin{frame}{Possible steady states}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.62\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.95cm,keepaspectratio]{figures/gierer_meinhardt/saddle_node.png}
...
\begin{frame}{The zero steady state is always stable}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.36\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.85cm,keepaspectratio]{figures/gierer_meinhardt/origin_stability.png}
...
\begin{frame}{The lower positive steady state is a saddle}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.85cm,keepaspectratio]{figures/gierer_meinhardt/saddle_portrait.png}
...
\begin{frame}{The upper positive steady state can be stable}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.51\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=4.85cm,keepaspectratio]{figures/gierer_meinhardt/node_spiral.png}
...
\begin{frame}{The saddle separates the two stable outcomes}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.65\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=5.35cm,keepaspectratio]{figures/gierer_meinhardt/full_phase_portrait.png}
      \begin{tikzpicture}[x=0.90cm,y=0.90cm]
        ...
        \draw[-{Latex[length=1.7mm]},HydraCyan,line width=0.9pt]
          plot[smooth] coordinates {(1.35,2.55) (1.10,1.55) (0.66,0.68)};
...
\begin{frame}{The general Turing theorem applies to GM}
...
\begin{frame}{Only GM eigenmodes inside the unstable band can grow}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.70\textwidth}
      ...
      % REPLACEABLE VISUAL
      % Replace the tikzpicture with:
      % \includegraphics[width=\linewidth,height=5.05cm,keepaspectratio]{figures/gierer_meinhardt/unstable_modes.png}
      \begin{tikzpicture}[x=0.88cm,y=0.88cm]
...
\begin{frame}{Example}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      \HydraPoint[HydraWhite]
        {No-flux boundaries}
        {$\partial_x u=\partial_x v=0$ at $x=0$ and $x=1$}
    \end{column}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.68\textwidth}
      ...
      \includegraphics[
        ...
        height=5.20cm,
        keepaspectratio
      ]{figures/gierer_meinhardt/gm_example_nullclines.png}
...
\begin{frame}{Unstable eigennodes}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.70\textwidth}
      ...
      \includegraphics[
        ...
        height=5.10cm,
        keepaspectratio
      ]{figures/gierer_meinhardt/gm_example_mode_growth_rates.png}
...
\begin{frame}{Unstable eigenodes on bigger domain $\Omega=[0,10]$}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.70\textwidth}
      ...
      \includegraphics[
        ...
        height=5.10cm,
        keepaspectratio
      ]{figures/gierer_meinhardt/gm_example_mode_growth_rates_L10.png}
...
%       % REPLACEABLE VISUAL
%       % Replace the tikzpicture with:
%       % \includegraphics[width=\linewidth,height=5.10cm,keepaspectratio]{figures/gierer_meinhardt/linear_to_nonlinear.png}
%       \begin{tikzpicture}[x=0.90cm,y=0.90cm]

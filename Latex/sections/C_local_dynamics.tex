\begin{frame}{Reaction}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      % \includegraphics[width=\linewidth,height=5.25cm,keepaspectratio]{figures/C_local_dynamics/...}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.53\textwidth}
      ...
      \includegraphics[
        ...
        height=5.45cm,
        keepaspectratio
      ]{figures/C_local_dynamics/vector_field.png}
...
\begin{frame}{Steady state}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.50\textwidth}
      ...
      %   height=5.40cm,
      %   keepaspectratio
      % ]{figures/C_local_dynamics/nullclines.png}
        ...
        \begin{columns}[c,onlytextwidth]
          ...
          \begin{column}{0.72\linewidth}
            ...
            \includegraphics[
              ...
              height=3.80cm,
              keepaspectratio
            ]{figures/C_local_dynamics/stability_converging.png}
            ...
            \includegraphics[
              ...
              height=3.80cm,
              keepaspectratio
            ]{figures/C_local_dynamics/stability_diverging.png}
          \end{column}
...
\begin{center}
  \includegraphics[
    ...
    height=6.75cm,
    keepaspectratio
  ]{figures/C_local_dynamics/EigenvalueNode.png}
\end{center}
...
%       % REPLACEABLE VISUAL
%       % Replace the tikzpicture with:
%       % \includegraphics[width=\linewidth,height=2.75cm,keepaspectratio]{figures/C_local_dynamics/...}

...
\begin{frame}{Symmetry breaking occurs in a regenerating spheroid}
...
\HydraSubsection[
  ...
  \mbox{morphogen signalling and mechanics}
]{Mechanics during regeneration}


\begin{frame}{Regenerating spheroids undergo mechanical oscillations}

  \vspace{-0.16cm}

  \begin{center}
    \begin{tikzpicture}[x=1cm,y=1cm]
      \fill[HydraPanel] (0.40,0.35) rectangle (14.70,5.05);
      \draw[HydraLine,line width=1.0pt,rounded corners=3pt]
        (0.40,0.35) rectangle (14.70,5.05);
      \fill[HydraGold,opacity=0.18] (7.55,2.70) circle[radius=1.05cm];
      \draw[HydraGold,line width=1.5pt] (7.55,2.70) circle[radius=1.05cm];
      \fill[HydraWhite] (7.55,2.70) circle[radius=0.17cm];
      \draw[-{Latex[length=3.0mm]},HydraWhite,line width=1.2pt]
        (7.34,2.70) -- (7.90,2.70);
      \node[text=HydraWhite,font=\bfseries\fontsize{10}{12}\selectfont]
        at (7.55,4.32) {REGENERATING HYDRA SPHEROID};
      \node[text=HydraMuted,font=\fontsize{7.6}{9.2}\selectfont]
        at (7.55,0.92) {observe gradual swelling followed by rapid collapse};
    \end{tikzpicture}
  \end{center}

  % Replace the panel above with the biological movie when the file is available
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.24\textwidth}
      ...
      {\color{HydraMuted}\fontsize{7.1}{8.7}\selectfont
        Morphogen signalling and tissue-scale mechanics cannot be treated independently
      \par}
    \end{column}
  \end{columns}
...
\begin{frame}{Experiments suggest a two-way mechanochemical coupling}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \vspace{0.24cm}
      {\color{HydraMuted}\fontsize{7.3}{9}\selectfont
        Morphogen signalling changes how strongly the tissue resists deformation
      \par}
    \end{column}
  \end{columns}
...
\begin{frame}{Local feedback interacts with a global mechanical constraint}
...
\begin{frame}{The spring application makes the mechanics tangible}
  ...
  \begin{columns}[c,onlytextwidth]
    \begin{column}{0.65\textwidth}
      ...
      \begin{tikzpicture}[x=1cm,y=1cm]
        ...
        \node[text=HydraMuted,font=\fontsize{7.3}{8.9}\selectfont]
          at (4.82,0.62) {LIVE SPRING MODEL};
      \end{tikzpicture}
    \end{column}
    ...
    \begin{column}{0.31\textwidth}
      \HydraPoint[HydraGold]
        {Move one node}
        {A local displacement changes several neighbouring springs}
      \vspace{-0.04cm}
      \HydraPoint[HydraCyan]
...
\begin{frame}{One equation realizes the activator--inhibitor paradigm}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.08\textwidth}
      \centering{\color{HydraCyan}\fontsize{22}{22}\selectfont $\bigg/$}
    \end{column}
...
\begin{frame}{Subcritical feedback permits abrupt switching}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.34\textwidth}
      ...
      \vspace{0.18cm}
      \begin{tikzpicture}
        \node[draw=HydraGold,rounded corners=2pt,fill=HydraPanel,
          minimum width=3.50cm,minimum height=1.20cm,
          text=HydraMuted,align=center,
          font=\fontsize{7.2}{8.8}\selectfont]
          {simulation placeholder\\abrupt inflation and relaxation};
      \end{tikzpicture}
    \end{column}
  \end{columns}
...
\begin{frame}{Supercritical feedback produces a gradual patterned response}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.34\textwidth}
      ...
      \vspace{0.18cm}
      \begin{tikzpicture}
        \node[draw=HydraCyan,rounded corners=2pt,fill=HydraPanel,
          minimum width=3.50cm,minimum height=1.20cm,
          text=HydraMuted,align=center,
          font=\fontsize{7.2}{8.8}\selectfont]
          {simulation placeholder\\gradual inflation and pattern growth};
      \end{tikzpicture}
    \end{column}
  \end{columns}

...
\begin{frame}{Could chemical signals determine where a head forms?}
  ...
  {figures/gierer_meinhardt/Concentration.png}
  {}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.29\textwidth}
      ...
      \includegraphics[
        ...
        height=2.15cm,
        keepaspectratio
      ]{figures/gierer_meinhardt/TuringPaper.png}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.30\textwidth}
      ...
      \includegraphics[
        ...
        height=2.25cm,
        keepaspectratio
      ]{figures/gierer_meinhardt/Alfred_Gierer.jpg}
      ...
      \includegraphics[
        ...
        height=2.25cm,
        keepaspectratio
      ]{figures/gierer_meinhardt/Hans_Meinhardt.jpg}
...
\begin{frame}{The activator--inhibitor idea}
  ...
  \begin{center}
    \includegraphics[
      ...
      height=5.5cm,
      keepaspectratio
    ]{figures/gierer_meinhardt/ActivatorInhibitor.png}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.27\textwidth}
      ...
      \includegraphics[
        ...
        height=2.65cm,
        keepaspectratio
      ]{figures/diffusion/Adolf_Fick_1897.jpg}
  ...
  \begin{columns}[c,onlytextwidth]
    ...
    \begin{column}{0.56\textwidth}
      ...
      \begin{align*}
        ...
        &=D\sum_{n=0}^{\infty}a_n(t)\phi_n'' = \partial_{xx} u(x,t)
      \end{align*}
      }
